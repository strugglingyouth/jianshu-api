...
class ArticleDetail(models.Model):
    ...
    views = models.CharField('阅读数', max_length=100)
    comments = models.CharField('评论数', max_length=100)
    likes = models.CharField('喜欢', max_length=100)
    tip = models.CharField('打赏', max_length=100)
